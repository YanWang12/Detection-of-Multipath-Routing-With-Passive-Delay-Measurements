...
set link_sn [list 0 1 2 3 4 3 6 5 7 8 9] ; set link_dn [list 1 2 3 4 5 6 7 8 8 9 10]
set link_bw [list 20 20 20 15 10 5 10 15 5 20 20] ; set link_dl [list 30 30 30 20 30 10 5 10 5 30 30]
...
for {set j 0} {$j < 24} {incr j} {
	build-tcp $n(3) $n(5) 1Mb  }
for {set j 0} {$j < 8} {incr j} {
	build-udp $n(3) $n(5) 1Mb  }
